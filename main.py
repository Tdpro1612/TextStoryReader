...
import os
from kivy.metrics import dp # Import dp nếu bạn dùng nó cho kích thước widget trong Python
...
class TextStoryReaderApp(App):
    ...
    def update_status_label(self, message):
        ...
        if self.library_screen and hasattr(self.library_screen, 'ids') and 'status_label' in self.library_screen.ids:
            ...
            self.show_simple_popup("Cảnh báo UI", f"Không thể hiển thị trạng thái: {message}")
    ...
    def update_library_books_ui(self):
        ...
        if self.library_screen:
            ...
            self.show_simple_popup("Cảnh báo UI", "Màn hình thư viện chưa sẵn sàng để cập nhật sách.")
